...
use alloy_evm::{EthEvm, Evm, precompiles::{PrecompilesMap, DynPrecompile}};
    ...
    DB::Error: Clone + Send + Sync + 'static,
{
    ...
    pub fn new(
        ...
        Self {
            ...
            custom_precompiles: custom_precompiles.unwrap_or_else(|| Arc::new(std::collections::HashMap::new())),
